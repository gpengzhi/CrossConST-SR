...
@register_model_architecture("laser_transformer", "laser_transformer_512")
def laser_transformer_architecture_512(args):
    ...
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 512 * 8)
...
@register_model_architecture("laser_transformer", "laser_transformer_768")
def laser_transformer_architecture_768(args):
    args.encoder_layers = getattr(args, "encoder_layers", 12)
    args.decoder_layers = getattr(args, "decoder_layers", 3)
    ...
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 768 * 8)
...
@register_model_architecture("laser_transformer", "laser_transformer_1024")
def laser_transformer_architecture_1024(args):
    args.encoder_layers = getattr(args, "encoder_layers", 12)
    args.decoder_layers = getattr(args, "decoder_layers", 3)
    ...
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 1024 * 8)
